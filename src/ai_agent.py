...
Будьте конкретны и информативны."""
    ...
    def _get_smart_fallback(self, user_message: str, selected_service: Optional[str] = None) -> str:
        ...
        service_responses = {
            'venture': """🚀 Venture Capital — инвестиции в стартапы и венчурные проекты

MAXCAPITAL предлагает профессиональное сопровождение инвестиций в венчурные проекты и стартапы на различных стадиях развития.

Наши возможности:
• Анализ и отбор перспективных проектов
• Due diligence и оценка рисков
• Структурирование сделок
• Портфельное управление
• Выход из инвестиций

💼 Для детальной консультации свяжитесь с нашим менеджером:
🌐 https://maxcapital.ch/contacts""",
            'hnwi': """💎 HNWI Consultations — индивидуальные консультации для состоятельных клиентов

Персональный подход к управлению капиталом для высокодоходных клиентов (HNWI).

Услуги включают:
• Индивидуальное финансовое планирование
• Оптимизация налогового планирования
• Структурирование активов
• Международные инвестиционные стратегии
• Конфиденциальное управление капиталом

💼 Для персональной консультации: https://maxcapital.ch/contacts""",
            'real estate': """🏛 Real Estate — премиальная недвижимость и инвестиции

Инвестиции в премиальную недвижимость в Швейцарии и других юрисдикциях.

Направления:
• Отбор премиальных объектов недвижимости
• Анализ инвестиционной привлекательности
• Юридическое сопровождение сделок
• Управление недвижимостью
• Оптимизация налогового режима

💼 Для консультации: https://maxcapital.ch/contacts""",
            'crypto': """₿ Crypto — криптовалютные стратегии и консалтинг

Профессиональные консультации по криптовалютным инвестициям и стратегиям.

Услуги:
• Разработка криптовалютных инвестиционных стратегий
• Анализ рынка и трендов
• Структурирование крипто-портфелей
• Юридическое сопровождение
• Безопасное хранение активов

💼 Для консультации: https://maxcapital.ch/contacts""",
            'm&a': """🤝 M&A — сопровождение сделок слияний и поглощений

Полный цикл сопровождения сделок M&A для корпоративных клиентов.
...
• Пост-мерджер интеграция

💼 Для консультации: https://maxcapital.ch/contacts""",
            'private equity': """📊 Private Equity — частные инвестиции и управление капиталом

Управление частными инвестициями и структурирование капитала.

Направления:
• Прямые инвестиции в компании
• Управление частным капиталом
• Структурирование инвестиционных фондов
• Операционное улучшение портфельных компаний
• Выход из инвестиций

💼 Для консультации: https://maxcapital.ch/contacts""",
            'relocation': """🌍 Relocation Support — поддержка релокации и международные решения

Комплексная поддержка при переезде и международные решения.

Услуги:
• Консультации по выбору юрисдикции
• Помощь в получении резидентства
• Открытие банковских счетов
• Налоговое планирование
• Юридическое сопровождение

💼 Для консультации: https://maxcapital.ch/contacts""",
            'банковск': """💳 Зарубежные банковские карты — открытие счетов и карт в международных банках

Помощь в открытии банковских счетов и получении карт в престижных международных банках.

Возможности:
• Открытие счетов в швейцарских банках
• Получение премиальных банковских карт
...
💼 Для консультации: https://maxcapital.ch/contacts"""
        ...
        if any(word in message_lower for word in ['услуг', 'услуги', 'что вы', 'что у вас']):
            return """Наши услуги MAXCAPITAL:
...
🌐 Подробнее: https://maxcapital.ch/"""
        
        # Use selected_service if available
        if selected_service:
            service_name = SERVICES.get(selected_service, selected_service)
            return f"""Благодарю за ваш вопрос по услуге: {service_name}

К сожалению, в данный момент доступ к AI-консультанту временно ограничен.

💼 Для получения детальной консультации по {service_name} свяжитесь с нашим менеджером:
🌐 https://maxcapital.ch/contacts

Наш менеджер ответит на все ваши вопросы и предоставит персональную консультацию."""
